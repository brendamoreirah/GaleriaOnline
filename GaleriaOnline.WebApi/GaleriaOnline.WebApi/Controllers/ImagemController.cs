...
namespace GaleriaOnline.WebApi.Controllers
{
    ...
    public class ImagemController : ControllerBase
    {
        ...
        //fornece informacoes da onde ele ta sendo hospedado
        ...
        //a task eh um tipo de retorno q eh uma tarefa
        public async Task<IActionResult> UploadImagem([FromForm] ImagemDTO dto)
        {
            ...
            //o guid gera um numero aleatorio
            ...
            AtualizarImagem(int id, PutImagemDto imagemAtualizada)
        {
            ...
            if (imagemAtualizada.Arquivo != null && imagemAtualizada.Arquivo.Length > 0)
            {
                ...
                var extensao = Path.GetExtension
                    (imagemAtualizada.Arquivo.FileName);
